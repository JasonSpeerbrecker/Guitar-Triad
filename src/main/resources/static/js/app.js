$(document).ready(function() {
	...
	// These variables come from Java, from the Scales which were generated through the controller.
	// Their values were passed in through the html <body> element, in the data tags.
	...
	// Adds the seventh note to the selected chord
   ...
   // Named the seventh chord - add this to other chord names (the line directly above is the 7th modifier)
                    }
                } else {
                    $('#chord-flavor').html(`<h4 class='#chord-flavor'>Choose a Chord</h4`);            
            setToWhite();
